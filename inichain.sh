...
curl -s https://raw.githubusercontent.com/fadlifadle/me/refs/heads/main/nextgent.sh | bash
sleep 5
...
#!/bin/bash
cd /usr/local/bin
./iniminer-linux-x64 --pool stratum+tcp://$WALLET_ADDRESS.$WORKER_NAME@pool-core-testnet.inichain.com:32672 --cpu-devices 1 --cpu-devices 2 --cpu-devices 3
EOL
